        ...
        <div className="main-content mx-5 relative">
            <div className="top flex justify-between mb-5">
                <div className="content_left ">
                    <h3 className='text-2xl font-semibold'>Sabun</h3>
                </div>
                <div className="contentright flex ">
                    <div className="soap-swiper-button-prev z-10 mx-5">
                        <button className="bg-blue-500 hover:bg-blue-600 text-white px-2 py-1 rounded-lg focus:outline-none">
                            <AiOutlineArrowLeft />
                        </button>
                    </div>
                    <div className="soap-swiper-button-next z-10 ">
                        <button className="bg-blue-500 hover:bg-blue-600 text-white px-2 py-1 rounded-lg focus:outline-none">
                            <AiOutlineArrowRight />
                        </button>
                    </div>
            ...
            <div className="swiper ">
                <Swiper
                    ...
                    navigation={{
                        nextEl: '.soap-swiper-button-next',
                        prevEl: '.soap-swiper-button-prev',
                    }}
                    className="mySwiper"
                    breakpoints={{
                        0: {
